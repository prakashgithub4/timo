            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="Offcanvas_menu_wrapper">
                        <a href="#"><img src="{{ asset('assets/fontend/img/logo/logo.png') }}" alt=""
                                class="leftlogo"></a>
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                <li><a href="#"><img
                                                            src="{{ asset('assets/fontend/img/nav-round.png') }}"
                                                            alt=""> Full Width</a></li>
                                                <li><a href="#"><img
                                                            src="{{ asset('assets/fontend/assets/img/nav-round.png') }}"
                                                            alt="">Full Width list</a></li>
                                                <li><a href="#"><img
                                                            src="{{ asset('assets/fontend/assets/img/nav-round.png') }}"
                                                            alt="">Right Sidebar </a></li>
                                                <li><a href="#"><img
                                                            src="{{ asset('assets/fontend/assets/img/nav-round.png') }}"
                                                            alt=""> Right Sidebar list</a></li>
                                                <li><a href="#"><img
                                                            src="{{ asset('assets/fontend/assets/img/nav-round.png') }}"
                                                            alt="">List View</a></li>
                                            </ul>
                                        ...
                                        <li class="menu-item-has-children">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li><a href="#l"><img
                                                            src="{{ asset('assets/fontend/img/nav-round.png') }}"
                                                            alt="">product sidebar</a></li>
                                                <li><a href="#"><img
                                                            src="{{ asset('assets/fontend/img/nav-round.png') }}"
                                                            alt="">product grouped</a></li>
                                                <li><a href="#"><img
                                                            src="{{ asset('assets/fontend/img/nav-round.png') }}"
                                                            alt="">product variable</a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            $.each(galleries, function(index,value) {
                                ...
                                let show = index ? '' : 'show';
                                modalBodyTop += '<div class="tab-pane fade '+show+' '+active+'" id="tab'+ index +'" role="tabpanel">\
                                ...
                                <div class="col-lg-7 col-md-7 col-sm-12" id="quickview">\
                                    <div class="modal_right">\
                                        ...
                                        <div class="modal_add_to_cart mb-15">\
                                            <form method="post">\
                                                <input min="0" max="100" step="2" id="qty" value="1" type="number">\
                                                <button type="button" onclick="addtocart('+response.data.id+')">add to cart</button>\
                                            </form>\
                                        </div>\
