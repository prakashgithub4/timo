        ...
        <div class="container">
            <div class="row">
                ...
                <div class="product-details-tab">
                        ...
                        <div class="degview modal-toggle"  data-bs-toggle="modal" data-bs-target="#degviewmodal2">
                        ...
                        @elseif($product->IsApi == 1)
                        <a href="{{$product->body}}"class="popup-youtube">
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <script src="https://cdn.scaleflex.it/plugins/js-cloudimage-360-view/2/js-cloudimage-360-view.min.js"></script>
                                      ...
                                      <iframe src="{{$product->body}}" width="100%" height="300" style="border:none;">
                                      </iframe>
                                </div>
                              </div>
                            </div>
                        ...
                        <!-- Modal -->
                        <div class="modal fade degviewmodal" id="degviewmodal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                              <div class="modal-header">
                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">x</button>
