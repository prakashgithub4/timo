            ...
            <div class="row">
                <div class="col-12">
                    <div class="breadcrumb_content">
                        <ul>
                            <li><a href="javascript:void(0)">{{$menuarray['menu_name']}}</a></li>
                            <li>&gt;</li>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12">
                    <div class="services_section_thumb">
                        <img src="{{asset('public/uploads/subcat_banner')}}/{{$menuarray['banner']}}" alt="{{$menuarray['menu_name']}}">
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
                    <div class="unlimited_services_content">
                        <h1>{{$menuarray['menu_name']}} Cut Diamonds</h1>
                        <p>{{strip_tags($menuarray['description'])}}</p>
                        <div class="view__work">
                            <a href="#">SHOP ALL {{$menuarray['menu_name']}} CUT DIAMONDS</a>
                        </div>  
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    @if(isset($products)&&count($products) > 25)
