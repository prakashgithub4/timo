                                    ...
                                    <tbody>
                                        ...
                                        @foreach (cart_list() as $carts)
                                            <tr class="cart_{{ $carts->id }}">
                                                ...
                                                <td class="product_thumb"><a href="#"><img src="{{ $carts->image_src }}"
                                                            alt=""></a></td>
                                                <td class="product_name"><a href="#">{{ $carts->seo_title }}</a></td>
                                                <td class="product-price">£{{ $carts->price }}</td>
                                                <td class="product_quantity"><label>Quantity</label> <input min="0"
                                                        max="100" name="quantities" value="{{ $carts->qty }}" type="number"></td>
                    ...
                    <div class="coupon_inner">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 col-md-4 col-12">
                                <h4 class="mb-0 text-center d-block mt-4"><strong>Coupon Price</strong> -£{{(!empty(@$coupon->discount)) ? $coupon->discount : '00.0'}}
                                </h4>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="coupon_code right">
                    ...
                    <div class="coupon_inner">
                        ...
                        <div class="cart_subtotal">
                            <p>Number of items</p>
                            <p class="cart_amount">{{empty($cart->quantities) ? '0' : $cart->quantities}}</p>
                        </div>
                        <div class="cart_subtotal">
                            <p>Item total</p>
                        ...
                        <div class="cart_subtotal">
                            <p>*Promo code: {{$coupon->coupon}} <button class="h-auto py-1 px-2">Remove</button>
                            </p>
                            <p class="cart_amount">-£{{(!empty(@$coupon->discount)) ? $coupon->discount : 00.0}}</p>
                        </div>
                       <!--  <div class="cart_subtotal ">
                            <p>Shipping</p>
