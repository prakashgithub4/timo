                ...
                <div class="col-md-5">
                    <div class="signUp_block">
                        <div class="signUp_frame">
                            <form action="{{ route('user.reset') }}" method="POST" id="forgetpassword">
                                @csrf
                                <div class="sign_top">
                                     <span  style="color:white"></span>
                                    <h3><img class="key"
                                            src="{{ asset('assets/fontend/img/icon/key.png') }}">Account Assistance</h3>
                                ...
                                <div class="main_form d-flex flex-column align-items-center">
                                    ...
                                    <div class="form-group w-100 email_blk">
                                        ...
                                        <input type="password" name="password" class="form-control" id="password"
                                            aria-describedby="emailHelp" placeholder="Enter Your Current Password">
