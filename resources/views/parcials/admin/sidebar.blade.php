    ...
    : '' }}">
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('admin/user/customer') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Customers</p>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.shapes') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Shapes</p>
                        </a>
                    </li>
            ...
            <li class="nav-item">
                ...
                <ul class="nav nav-treeview">
                    ...
                    <li class="nav-item">
                        <a href="{{ route('admin.gifts') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Gifts</p>
                        </a>
                    </li>
                    ...
                    <!-- <li class="nav-item">
                        <a href="{{ route('admin.category.sub') }}" class="nav-link">
                            <i class="far fa-circle nav-icon"></i>
                            <p>Sub Categories</p>
                        </a>
                    </li> -->
