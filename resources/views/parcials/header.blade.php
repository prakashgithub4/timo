                        ...
                        <div class="box_setting"  style="border-right: 0px;">
                            ...
                            <div class="dropdown_setting">
                               <ul>
                                    ...
                                    <li><a href="{{route('user.account','settings')}}"><i class="fa fa-cog" aria-hidden="true"></i> Account Settings </a></li>
                                    <li><a href="{{route('user.account','order')}}"><i class="fa fa-truck" aria-hidden="true"></i> Orders </a></li>
                                    <li><a href="{{route('user.account','returns')}}"><i class="fa fa-history" aria-hidden="true"></i> Returns </a></li>
                                    <li><a href="{{route('wishlist')}}"><i class="fa fa-heart" aria-hidden="true"></i> Wishlist</a></li>
                                    <li><a href="{{route('user.account','address')}}"><i class="fa fa-book" aria-hidden="true"></i> Address Book </a></li>
                                    <li><a href="{{route('compair')}}"><i class="fa fa-book" aria-hidden="true"></i> Compair </a></li>
                                    <li><a href="{{route('user.account','credit-card')}}"><i class="fa fa-credit-card" aria-hidden="true"></i> Credit Card </a></li>
                                        ...
                                        <div class="cart_item" id="cart_{{$carts->id}}">
                                           <div class="cart_img">
                                            ...
                                            <div class="cart_remove">
                                                <a href="javascript:removecart({{ $carts->id }})"><i class="ion-android-close"></i></a>
                                            </div>
                                        </div>
                                     @endforeach
                                   <!--  <div class="cart_item">
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-2 col-md-3 col-4">
                    <div class="logo">
                        <a href="{{url('/')}}"><img src="{{asset('assets/fontend/img/logo/logo.png')}}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-10">
                                    ...
                                    <div class="main_menu"> 
                                        <nav>  
                                            <ul>
                                                ...
                                                <?php  $mymenu= \App\Models\Menu::where('head_on', '1')->get();?>

                                                @foreach($mymenu as $menu)
                                                @if($menu->top==1)
                                                <li><a href="javascript:void(0)">{{$menu->menu_name}} <i class="fa fa-angle-down"></i></a>
                                                <?php  $menuCategory= \App\Models\ProductCategory::where('menu_id', $menu->id)->get();?>
                                                    ...
                                                    @foreach($menuCategory as $menu_cat)
                                                        ...
                                                        <li><a href="javascript:void(0)">{{$menu_cat->product_category}}</a>
                                                        <?php  $menuSubCategory = \App\Models\ProductSubCategory::where('menu_id', $menu->id)->where('product_category_id',$menu_cat->product_category_id)->get();?>
                                                            <ul>
                                                                ...
                                                                <li><a href="javascript:void(0)">@if(is_null($mSC->icon))<img src="{{asset('assets/fontend/img/nav-round.png')}}" alt="">@else <img src="{{asset('public/uploads/subcat_icons/'.$mSC->icon)}}">@endif {{$mSC->sub_category_name}}</a></li>
                                                                @endforeach
                                                            </ul>
                                                        </li>
                                                        @endif
                                                ...
                                                <li><a href="javascript:void(0)">@if(is_null($mSubCat2->icon))<img src="{{asset('assets/fontend/img/nav-round.png')}}" alt="">@else <img src="{{asset('public/uploads/subcat_icons/'.$mSubCat2->icon)}}">
                                                    @endif
