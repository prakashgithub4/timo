                        ...
                        <div class="bs-stepper">
                            ...
                            <form id="myform" action='{{ route('admin.productSubCategory.save') }}' method="POST"
                                ...
                                <input type="hidden" name='id'
                                    ...
                                    <div class="form-group col-md-4" style="display:none;" id="menu_category"> 
                                    ...
                                    <div class="form-group col-md-4" style="display:none;" id="menu_product_category">
                                      ...
                                      <div class="form-group col-md-4" style="display:none;" id="menu_product_icon">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <button type="submit" class="btn btn-primary" style="text-align:left;">Submit</button>
                                    </div>
                                    </div>              
...
//  });
 $.ajax({
             ...
             $("#menu_category").css("display", "");
             $("#menu_product_category").css("display", "");
             $("#menu_product_icon").css("display", "");;
            ...
            console.log(data)
             ...
             {  console.log(data[i].product_category)
                 html +=`<option value="${data[i].product_category_id}">${data[i].product_category}${data[i].mega_menu==1? '(MEGA MENU)': ''}</option> `;

             }

              $('#undercat').html(`<option value="">--Select Category -----</option>${html}`);
