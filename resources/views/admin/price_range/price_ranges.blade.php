        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Price Ranges</a></li>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <label><a href="{{route('admin.price_range') }}" class="btn btn-success">Add</a></label>
                        <table id="example2" class="table table-bordered table-hover">
                            ...
                            <tbody>
                              @forelse($pric_rangs as $key=>$item)
                                <tr>
                                    <td>{{$key+1}}</td>
