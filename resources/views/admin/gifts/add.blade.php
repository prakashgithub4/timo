            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Gift</a></li>
                    ...
                    <div class="card card-default">
                        <div class="card-body">
                            <div class="bs-stepper">
                                ...
                                <form id="myform" action="{{ route('admin.gift.save') }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <input type="hidden" name='id'
                                        value="{{ isset($gifts) ? $gifts->id : 0 }}" />
                                        ...
                                        <div id="logins-part" class="content" role="tabpanel"
                                            ...
                                            <div class="form-group">
                                                <label for="name">{{ __('Description') }} <span
                                                        style='color:red'>*</span></label>
                                                <input type ="text" name="short" class="form-control" value="{{ isset($gifts) ? $gifts->description : '' }}"/>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label for="name">{{ __('image') }}
                                                    <input type="file" name="image" class="form-control"
                                                        ...
                                                        required />
                                                        <img src="{{asset('public/uploads/gifts')}}/{{isset($gifts) ? $gifts->image : null }}" id='output' style="height:100px; width:100px; display:{{ isset($gifts->image) ? 'block' : 'none' }}">
                                                    @error('name')
                                                        <small style="color:red">{{ $message }}</small>
                                                    @enderror
                                            </div>
