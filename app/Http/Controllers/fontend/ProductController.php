...
class ProductController extends Controller
{
    public function index($id)
    {
      ...
      $product_attribute_values =  json_decode($product->attribute_values);
       ...
       ->where('products.id',$product_id)
       ->get();
       $threesixtyview = Animated::where('product_id','=',$product_id)->get();
      ...
      return view('fontend.product_details',compact('product','attribute_array','realted_products','product_image_array','recent_view','attribute_data','review','threesixtyview'));
    }
